<?php
// template name: entité map architecture
 ?>
<?php
/**
...
<div id="_1" class="rubrique_entite">
			<div class="cellule_entite_gauche">
						<div class="bande_colo fond_gris_fonce alignleft">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/logo/map.png" width="200px" style="padding-left:50px"/>
						</div>
			</div>
			<!------------------------- 2 ---------------------------------------------->
...
<!---------------------------- 7 ------------------------------------------->
<div id="_7_map" class="rubrique_entite">
			<div class="cellule_entite_gauche">
			...
			<!---------------------------- 8 ------------------------------------------->
			<div id="equipe_map" class="cellule_entite_droite">
						<!-- Début de la Boucle équipe---->
						<!-- on recupere la liste des associés -->
						<?php $args = array(
										'orderby' => 'title',
										'order'   => 'ASC',
