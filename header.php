...
<header id="masthead" class="site-header" role="banner">
			<!-- section haut header-->
			<section id="haut" class="section_haut fond_gris_fonce">
						<div id="logo_map" class="map_logo">
						...
						<!-- div fin map logo -->
						<!-- div centrage menu iconique -->
						<div id="centrage" class="centre_menu">
						...
						<!-- fin div centrage menu iconique -->
			</section>
			<!-- fin section haut header -->
			<hgroup>
						<h1 class="site-title">
